...
def ver_subcategorias(request):
    ...
    if request.GET.get("q"):
        ...
        prod+=prod.filter(subcategoria__nombre__icontains=request.GET.get("q"))
        prod+=prod.filter(etiquetas__icontains=request.GET.get("q"))
        prod+=prod.filter(marca__nombre__icontains=request.GET.get("q"))
        prod+=prod.filter(establecimiento__nombreComercial__icontains=request.GET.get("q"))
        prod+=prod.filter(descripcion__icontains=request.GET.get("q"))
        prod+=prod.filter(detallesTecnicos__icontains=request.GET.get("q"))
